export const openKoreanGenesisMeta = {
  source: 'seven1m/open-bibles kor-korean.osis.xml',
  sourceUrl: 'https://github.com/seven1m/open-bibles/blob/master/kor-korean.osis.xml',
  originalStoredAt: 'data/original-bible/kor-korean.osis.xml',
  license: 'Public Domain as listed by seven1m/open-bibles README',
  osisId: 'kor',
  book: 'Genesis',
  chapters: '1-10',
} as const;

export const openKoreanGenesis1To10 = {
    "1":  {
...
export type OpenKoreanGenesisChapter = keyof typeof openKoreanGenesis1To10;
